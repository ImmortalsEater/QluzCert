...
if 'perm_comissoes' not in current_header:
    new_header = current_header + ['perm_comissoes']
    ...
    print('Coluna perm_comissoes adicionada.')
    print('Novo cabecalho:', new_header)
else:
    print('Usuarios ja tem perm_comissoes, nada a fazer.')
