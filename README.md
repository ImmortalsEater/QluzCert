...
- Testes automatizados cobrem `parsing.py` e `sheets_repository.py` (`python manage.py test core.app_Gestor.tests`); os scripts em `scripts/` continuam sendo checagens manuais avulsas, não testes de CI.
